...
namespace Orleans.Providers.Streams.Common
{
    ...
    /// </summary>
    [RegisterSerializer]
    public class EventSequenceToken2 : EventSequenceToken
    {
        /// <summary>
        /// Sequence token constructor
        /// </summary>
        /// <param name="seqNumber"></param>
        public EventSequenceToken2(long seqNumber) : base(seqNumber)
        {
        }
        ...
        public EventSequenceToken2(long seqNumber, int eventInd) : base(seqNumber, eventInd)
        {
        }
        ...
        {
            SerializationManager.Register(typeof(EventSequenceToken2), DeepCopy, Serialize, Deserialize);
        }
        ...
        {
            var source = original as EventSequenceToken2;
            if (source == null)
            {
                return null;
            }

            var copy = new EventSequenceToken2(source.SequenceNumber, source.EventIndex);
        ...
        {
            var typed = untypedInput as EventSequenceToken2;
            if (typed == null)
            {
                writer.WriteNull();
                return;
        ...
        {
            var result = new EventSequenceToken2(reader.ReadLong(), reader.ReadInt());

...
namespace OrleansServiceBus.Providers.Streams.EventHub
{
    ...
    /// </summary>
    [RegisterSerializer]
    public class EventHubSequenceToken2 : EventHubSequenceToken
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public EventHubSequenceToken2(string eventHubOffset, long sequenceNumber, int eventIndex)
        ...
        {
            SerializationManager.Register(typeof(EventHubSequenceToken2), DeepCopy, Serialize, Deserialize);
        }
        ...
        {
            var source = original as EventHubSequenceToken2;
            if (source == null)
            {
                return null;
            }

            var copy = new EventHubSequenceToken2(source.EventHubOffset, source.SequenceNumber, source.EventIndex);
        ...
        {
            var typed = untypedInput as EventHubSequenceToken2;
            if (typed == null)
            {
                writer.WriteNull();
                return;
        ...
        {
            var deserialized = new EventHubSequenceToken2(reader.ReadString(), reader.ReadLong(), reader.ReadInt());

...
namespace Orleans.ServiceBus.Providers
{
    ...
    public class EventHubBatchContainer : IBatchContainer
    {
        ...
        public EventHubBatchContainer(EventHubMessage eventHubMessage)
        {
            ...
            token = new EventHubSequenceToken2(eventHubMessage.Offset, eventHubMessage.SequenceNumber, 0);
        }
        ...
        {
            return Payload.Events.Cast<T>().Select((e, i) => Tuple.Create<T, StreamSequenceToken>(e, new EventHubSequenceToken2(token.EventHubOffset, token.SequenceNumber, i)));
        }

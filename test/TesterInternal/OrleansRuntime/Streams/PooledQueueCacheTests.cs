    ...
    public class PooledQueueCacheTests
    {
        ...
        private class TestCacheDataAdapter : ICacheDataAdapter<TestQueueMessage, TestCachedMessage>
        {
            ...
            public StreamPosition GetStreamPosition(TestQueueMessage queueMessage)
            {
                ...
                StreamSequenceToken sequenceToken = new EventSequenceToken2(queueMessage.SequenceNumber);
        ...
        private int RunGoldenPath(PooledQueueCache<TestQueueMessage, TestCachedMessage> cache, int startOfCache)
        {
            ...
            object stream1Cursor = cache.GetCursor(stream1, new EventSequenceToken2(startOfCache));
            ...
            object stream2Cursor = cache.GetCursor(stream2, new EventSequenceToken2(startOfCache));
        ...
        public void QueueCacheMissTest()
        {
            ...
            object cursor = cache.GetCursor(streamId, new EventSequenceToken2(sequenceNumber++));
            ...
            try
            {
                cache.GetCursor(streamId, new EventSequenceToken2(10));
            }
            catch (QueueCacheMissException cacheMissException)
            {
                ex = cacheMissException;
            ...
            cursor = cache.GetCursor(streamId, new EventSequenceToken2(13));

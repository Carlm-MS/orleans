...
namespace UnitTests.OrleansRuntime.Streams
{
    public class CachedMessageBlockTests
    {
        ...
        private class TestCacheDataComparer : ICacheDataComparer<TestCachedMessage>
        {
            ...
            {
                var myToken = new EventSequenceToken2(cachedMessage.SequenceNumber, cachedMessage.EventIndex);
        ...
        private class TestCacheDataAdapter : ICacheDataAdapter<TestQueueMessage, TestCachedMessage>
        {
            ...
            {
                return new EventSequenceToken2(cachedMessage.SequenceNumber, cachedMessage.EventIndex);
            }
        ...
        public void FirstMessageWithSequenceNumberTest()
        {
            ...
            Assert.Equal(block.OldestMessageIndex, block.GetIndexOfFirstMessageLessThanOrEqualTo(new EventSequenceToken2(0), TestCacheDataComparer.Instance));
            Assert.Equal(block.OldestMessageIndex, block.GetIndexOfFirstMessageLessThanOrEqualTo(new EventSequenceToken2(1), TestCacheDataComparer.Instance));
            Assert.Equal(block.NewestMessageIndex, block.GetIndexOfFirstMessageLessThanOrEqualTo(new EventSequenceToken2(sequenceNumber - 2), TestCacheDataComparer.Instance));
            Assert.Equal(block.NewestMessageIndex - 1, block.GetIndexOfFirstMessageLessThanOrEqualTo(new EventSequenceToken2(sequenceNumber - 3), TestCacheDataComparer.Instance));
            Assert.Equal(50, block.GetIndexOfFirstMessageLessThanOrEqualTo(new EventSequenceToken2(sequenceNumber / 2), TestCacheDataComparer.Instance));
            Assert.Equal(50, block.GetIndexOfFirstMessageLessThanOrEqualTo(new EventSequenceToken2(sequenceNumber / 2 + 1), TestCacheDataComparer.Instance));
        }
        ...
        public void NextInStreamTest()
        {
            ...
            while (block.HasCapacity)
            {
                ...
                var message = new TestQueueMessage
                {
                    ...
                    SequenceToken = new EventSequenceToken2(sequenceNumber)
                };
